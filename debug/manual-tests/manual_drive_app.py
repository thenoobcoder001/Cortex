...
def drive_app():
    ...
    # We can't easily read the TUI screen, but we can check the Gemini CLI trace log.
    trace_path = Path("e:/codex/gpt-tui/out/logs/trace.log")
    if trace_path.exists():
        content = trace_path.read_text(encoding="utf-8")
        last_lines = content.splitlines()[-20:]
        print("\nLast lines of out/logs/trace.log:")
